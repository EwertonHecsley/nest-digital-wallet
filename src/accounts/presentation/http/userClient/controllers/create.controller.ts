...
export class CreateUserClientController{
    constructor(private readonly createUserClientUseCase:CreateUseClientUseCase){}

    @Post()
    @HttpCode(201)
    async handler(@Body() data: CreateUserClientDTO, @Res() response: Response):Promise<void>{
